...
**Source of truth:** `precursor.json` → `.cursor/rules/python.mdc` is generated from it. Commands and tooling references match config; no stray tools (e.g. mypy) unless added to schema and config.

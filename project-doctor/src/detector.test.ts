...
describe("detector", () => {
  // Use subproject so getWorkspaceRoot returns process.cwd() (where tests write marker files).
  // With mode "auto", root would be git toplevel (parent repo), so detection would look in the wrong dir.
